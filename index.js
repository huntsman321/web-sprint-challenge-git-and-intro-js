...
function lotsOfArt(artists) {
  const prolificArtists = artists.filter(artist => artist.paintings > 100); 
...
function artistByCountry(artists, nationality){
  const artistNames = artists.filter(artist => artist.nationality === nationality && artist.nationality.split(',').length === 1)
